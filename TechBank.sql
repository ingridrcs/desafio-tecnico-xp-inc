...
(10);
	...
	CREATE TABLE TechBank.Assets (
    CodAtivo INTEGER PRIMARY KEY NOT NULL,
    QtAtivo INTEGER,
    Valor DECIMAL(5,2)
    ) ENGINE=INNODB;

  INSERT INTO TechBank.Assets (CodAtivo, QtAtivo, Valor)
VALUES 
(111,100,35.00),
(222,100,35.00),
(333,100,35.00);

	CREATE TABLE TechBank.AssetsClient (
    ...
    REFERENCES Accounts (codCliente)
    ON DELETE CASCADE,
	FOREIGN KEY (CodAtivo)
    REFERENCES Assets (CodAtivo)
    ON DELETE CASCADE
    ) ENGINE=INNODB;

  INSERT INTO TechBank.AssetsClient (CodCliente, CodAtivo, QtAtivo, Valor)
VALUES 
(1,111,100,350.00),
(1,222,100,350.00),
(1,333,100,350.00);